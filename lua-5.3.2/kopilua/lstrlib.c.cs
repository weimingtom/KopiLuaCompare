	...
	public partial class Lua
	{
		...
		*/
		...
		public class MatchState {
		  ...
		  public lua_State L;
		  public uint nrep;  /* limit to avoid non-linear complexity */
		...
		*/
		//#if !defined(A_REPS)
		public const int A_REPS	= 4;
		public const int B_REPS	= 100000;
		//#endif
...
//		#endif				/* } */
		...
		*/
		...
		private const char LUA_PACKPADBYTE = (char)0x00;
		//#endif
		  ...
		  while (fmt[0] != '\0') {
		    ...
		    switch (opt) {
		      ...
		      case KOption.Kchar: {  /* fixed-size string */
		        ...
		        if ((uint)size <= len)  /* string larger than (or equal to) needed? */
		          luaL_addlstring(b, s, (uint)size);  /* truncate string to asked size */
		      ...
		      case KOption.Kpadding: luaL_addchar(b, LUA_PACKPADBYTE);  /* FALLTHROUGH */
