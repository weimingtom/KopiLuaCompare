...
namespace KopiLua
{
	...
	public partial class Lua
	{
		...
		*/
		...
		public static int lua_number2str(CharPtr s, int sz, lua_Number n) { return l_sprintf(s, sz, LUA_NUMBER_FMT, n); }
		...
		*/
		...
		public static int lua_integer2str(CharPtr s, int sz, lua_Integer n)	{ return l_sprintf(s, sz, LUA_INTEGER_FMT, n); }
		...
		*/
		...
		//#else
		public static int l_sprintf(CharPtr s, int sz, CharPtr f, object i)	{ /*(void)(sz),*/ return sprintf(s,f,i); }
		//#endif
		...
		*/
		//#if !defined(LUA_USE_C89)
		public static int lua_number2strx(lua_State L, CharPtr b, int sz, CharPtr f, double n)	{ /*(void)L;*/ return l_sprintf(b,sz,f,n); }
		//#endif
		...
		*/
		...
		public static char lua_getlocaledecpoint() { return (localeconv().decimal_point[0]); }
		//#endif
