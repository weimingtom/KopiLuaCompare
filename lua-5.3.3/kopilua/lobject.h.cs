...
namespace KopiLua
{
	...
	public partial class Lua
	{
		...
		*/
		public const int LUA_TPROTO	= LUA_NUMTAGS;		/* function prototypes */
		public const int LUA_TDEADKEY	= (LUA_NUMTAGS+1);		/* removed keys in tables */
		...
		*/
		public class GCObject : CommonHeader {
		};
...
//				v1._parent = v2._parent;
		...
		public static lua_Number nvalue(TValue o) { return (lua_Number)check_exp(ttisnumber(o),
		...
		public static void checkliveness(lua_State L, TValue obj) {
		...
		public static void chgfltvalue(TValue obj, lua_Number x)
		  { TValue io=obj; lua_assert(ttisfloat(io)); io.value_.n=(x); } //FIXME:chagned, val_(io)

		public static void setivalue(TValue obj, lua_Integer x)
		  { TValue io=obj; io.value_.i=x; settt_(io, LUA_TNUMINT);}

		public static void chgivalue(TValue obj, lua_Integer x)
		  { TValue io=obj; lua_assert(ttisinteger(io)); io.value_.i=(x); } //FIXME:chagned, val_(io)
		...
		public static void setgcovalue(lua_State L, TValue obj, GCObject x)
		  { TValue io = obj; GCObject i_g = x;
		    io.value_.gc=i_g; settt_(io, ctb(i_g.tt)); } //FIXME:chagned, val_(io)
	
		public static void setsvalue(lua_State L, TValue obj, GCObject x) 
		  {  TValue io = obj; TString x_ = (TString)x;
		     io.value_.gc = obj2gco(x_); settt_(io, ctb(x_.tt)); //FIXME:chagned, val_(io)
			 checkliveness(L,io); }
		...
		*/
		...
		public static void setobj2t(lua_State L, TValue o1, TValue o2) { /*(void)L,*/ lua_TValue.copy(o1, o2); checkliveness(L,o1); }
		...
		*/
		public class TString : GCUnion { //FIXME:added
            //CommonHeader;
			public lu_byte extra;  /* reserved words for short strings; "has hash" for longs */
			public lu_byte shrlen;  /* length for short strings */
			public uint hash;
			public TString_u u = new TString_u();
		
			public TString() { }
			public UTString parent_;
		...
		public class TStringPtrRef : TStringRef {
			private TString tsv;
			
			public TStringPtrRef(TString tsv)
			{
				this.tsv = tsv;
			}
			public TString get()
			{
				return this.tsv.u.hnext;
			}
			public void set(TString v)
			{
				this.tsv.u.hnext = v;
		...
		*/
		public class UTString : TString {
		  public L_Umaxalign dummy = new L_Umaxalign();  /* ensures maximum alignment for strings */
		  public TString tsv { get { return (TString)this; } }
		};
		...
		*/
		public static CharPtr getstr(TString ts)  {
			if (ts.str == null) throw new Exception();
			return (CharPtr)check_exp(1/*sizeof((ts)->extra)*/, ts.str); }
			//throw new Exception(); return null; } //  check_exp(sizeof((ts)->extra), cast(char *, (ts)) + sizeof(UTString)) //FIXME:
		...
		public static uint tsslen(TString s)	{ return (s.tt == LUA_TSHRSTR ? s.shrlen : s.u.lnglen); }

		/* get string length from 'TValue *o' */
		public static uint vslen(TValue o)	{ return tsslen(tsvalue(o)); }
		...
		** Ensures that address after this type is always fully aligned.
		*/
		private class UUdata {
		  public L_Umaxalign dummy = new L_Umaxalign();  /* ensures maximum alignment for 'local' udata */
		  public Udata uv = new Udata();
		};
		...
		*/
		...
		public static void setuservalue(lua_State L, Udata u, TValue o)
			{ TValue io=(o); Udata iu = (u);
			  iu.user_ = io.value_; iu.ttuv_ = (byte)rttype(io);
			  checkliveness(L,io); }
		...
		*/
		public class Upvaldesc : ArrayElement {
		  ...
		  public lu_byte instack;  /* whether it is in stack (register) */
		...
		*/
		public class Proto : GCUnion {
		  ...
		  public lu_byte is_vararg;  /* 2: declared vararg; 1: uses vararg */
		  public lu_byte maxstacksize; /* number of registers needed by this function */
		...
		*/
		...
		public class ClosureHeader : GCUnion {
		...
		*/
		...
		public class Table : GCUnion {
		  ...
		  private uint _sizearray;  /* size of 'array' array */
