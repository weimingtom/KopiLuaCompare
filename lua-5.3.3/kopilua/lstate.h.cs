	...
	*/
	public partial class Lua
	{
		...
		*/
		...
		public const int CIST_FRESH = (1<<3);	/* call is running on a fresh invocation
                                   					of luaV_execute */
		...
		public const int CIST_LEQ	= (1<<7);  /* using __lt for __le */
		...
		*/
		public class global_State {
		  ...
		  public l_mem totalbytes;  /* number of bytes currently allocated - GCdebt */
		  ...
		  public TString[][] strcache = new TString[STRCACHE_N][/*1*/];  /* cache for strings in API */
		  
		  public global_State()
		  {
		  	for (int i = 0; i < strcache.Length; ++i)
		  	{
		  		strcache[i] = new TString[STRCACHE_M];
		  	}
		  }
		...
		*/
		...
		public static lu_mem gettotalbytes(global_State g) { return (lu_mem)(g.totalbytes + g.GCdebt); } //FIXME:(uint)
