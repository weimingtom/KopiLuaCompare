...
namespace KopiLua
{
	public partial class Lua
	{
		...
		*/
		...
		static void AddTotalBytes(lua_State L, int num_bytes) { G(L).totalbytes += (int)num_bytes; }
		static void SubtractTotalBytes(lua_State L, int num_bytes) { G(L).totalbytes -= (int)num_bytes; }

		static void AddTotalBytes(lua_State L, uint num_bytes) {G(L).totalbytes += (int)num_bytes;}
		static void SubtractTotalBytes(lua_State L, uint num_bytes) {G(L).totalbytes -= (int)num_bytes;}
	}
}
