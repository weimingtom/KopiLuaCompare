...
namespace KopiLua
{
	...
	public partial class Lua
	{
		...
		*/
		...
		private static int typeerror (lua_State L, int narg, CharPtr tname) {
		...
		*/
		...
		private static void interror (lua_State L, int narg) {
		...
		public static lua_Integer luaL_optinteger (lua_State L, int narg, 
		                                                        lua_Integer def) {
