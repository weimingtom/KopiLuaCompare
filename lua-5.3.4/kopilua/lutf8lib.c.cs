...
namespace KopiLua
{
	...
	public partial class Lua
	{
		...
		*/
		private static /*const*/ uint[] utf8_decode_limits = {0xFF, 0x7F, 0x7FF, 0xFFFF};
		...
		*/
		...
		public static int luaopen_utf8 (lua_State L) {
		  luaL_newlib(L, funcs);
		  lua_pushlstring(L, UTF8PATT, (uint)UTF8PATT.Length/*sizeof(UTF8PATT)/sizeof(char) - 1*/);
