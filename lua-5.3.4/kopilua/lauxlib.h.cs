...
namespace KopiLua
{
	...
	public partial class Lua
	{
		...
		*/
		...
		public static int luaL_getmetatable(lua_State L, CharPtr n) { return lua_getfield(L, LUA_REGISTRYINDEX, n); }
		...
		*/
		...
		public static void lua_writestring(CharPtr s, uint l)   { fwrite((s), 1/*sizeof(char)*/, (int)(l), stdout); }
		//#endif

		/* print a newline and flush the output */
		//#if !defined(lua_writeline)
		public static void lua_writeline()        { lua_writestring("\n", 1); fflush(stdout); }
		//#endif

		/* print an error message */
		//#if !defined(lua_writestringerror)
		public static void lua_writestringerror(CharPtr s, object p) {
		...
		*/
		...
		public static lua_Unsigned luaL_optunsigned(lua_State L, int a, lua_Integer d)	{
			return ((lua_Unsigned)luaL_optinteger(L,a,(lua_Integer)(d))); }
