...
namespace KopiLua
{
	...
	public partial class Lua
	{
		...
		*/
		...
		public static int lua_number2str(CharPtr s, int sz, lua_Number n) { 
		...
		*/
		...
		public static int lua_integer2str(CharPtr s, int sz, lua_Integer n)	{ 
		...
		*/
		//#if !defined(LUA_USE_C89)
		public static int lua_number2strx(lua_State L, CharPtr b, int sz, CharPtr f, double n)	{ 
		  /*(void)L;*/ return l_sprintf(b,sz,f,(LUAI_UACNUMBER)(n)); }
		//#endif
